...
function setImpossibleQuestion(question_number, smart_score) {
...
function submitImpossibleAnswer() {
...
setImpossibleQuestion(localStorage.getItem("question_num_add"), localStorage.getItem('ss_addition'));
